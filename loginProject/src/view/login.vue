<template>
    <div id="login">
        ...
        <div class="login_header">三台县数字农业信息资源平台</div>
            ...
            <div class="login-form">
                <form class="form">
                    <div class="input-div">
                        ...
                        <input type="text"  v-model="loginForm.userAccount" class="input username" name="username" value="" placeholder="请输入账号">
                    </div>

                    <div class="input-div">
                        <div class="icon_text"><i class="el-icon-lock"></i></div>
                        <input type="password" v-model="loginForm.userPassword" class="input password" name="password" value="" placeholder="请输入密码">
                    </div>
                    ...
                    <el-row class="row">
                        ...
                        <el-col :span="14">
                            ...
                            <!-- <el-input   
                                ...
                                placeholder="请输入验证码" 
                            ></el-input> -->
                            <input type="text" v-model="loginForm.code" class="input code" name="code" value="" placeholder="请输入验证码">
                        </el-col>
                        <el-col :span='10'>
        ...
        loginSubmit() {  
            if (this.loginForm.userAccount === '' && this.loginForm.userPassword === '') {
                ...
                /* } else if (this.loginForm.phoneNo == '') {
                     this.msg = "请输入手机号";
                     return;
                 }else if(!(/^1[3456789]\d{9}$/.test(this.loginForm.phoneNo))){
                     this.msg = "请输入正确的手机号";
                     return;  */
        ...
        async login () {
            ...
            if(res.data.code == 0){
                ...
                if(this.rememberMe){   
                    ...
                    this.setCookie(this.loginForm.userAccount,this.loginForm.userPassword,this.rememberMe,30)
                }else{
            ...
            if(res.data.code == 0){
                ...
                if(this.systemList.length === 1){
                   ...
                   // let phoneNo = sessionStorage.getItem("phoneNo")
                    ...
                    window.location.href=`${this.systemList[0].menuUrl}?firstMenuId=${firstMenuId}&authToken=${authToken}&userAccount=${encodeURIComponent(userAccount)}`;
                }else{
