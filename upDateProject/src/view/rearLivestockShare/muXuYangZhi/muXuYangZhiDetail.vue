                        ...
                        <div class="formContent">
                            <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                                ...
                                <el-form-item label="年内出栏" class="formItem">
                                    <el-input v-model="ruleForm.cattleOutColumn" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入年内出栏"></el-input> （头）
                                </el-form-item>
                                <el-form-item label="年末存栏" class="formItem">
                                    <el-input v-model="ruleForm.cattleExistColumn" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入年末存栏"></el-input> （头）
                                </el-form-item>
                    ...
                    <el-collapse-item name="2">
                        ...
                        <div class="formContent">
                            <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                                ...
                                <el-form-item label="年内出栏" class="formItem">
                                    <el-input v-model="ruleForm.sheepOutColumn" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入年内出栏"></el-input> （头）
                                </el-form-item>
                                <el-form-item label="年末存栏" class="formItem">
                                    <el-input v-model="ruleForm.sheepExistColumn" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入年末存栏"></el-input> （头）
                                </el-form-item>
                            ...
                            <el-collapse v-model="activeNames" @change="handleChange">
                                <el-collapse-item name="3-1">
                                    ...
                                    <div class="formContent">
                                        ...
                                        <el-form-item label="年内出栏" class="formItem">
                                            <el-input v-model="ruleForm.chickenOutColumn" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入年内出栏"></el-input> （只）
                                        </el-form-item>
                                        <el-form-item label="年末存栏" class="formItem">
                                            <el-input v-model="ruleForm.chickenExistColumn" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入年末存栏"></el-input> （只）
                                        </el-form-item>
                                        ...
                                        <el-collapse-item name="3-1-1">
                                            ...
                                            <div class="formContent">
                                                <el-form :model="ruleForm" status-icon label-width="100px" class="demo-ruleForm">
                                                    <el-form-item label="年内出栏" class="formItem">
                                                        <el-input v-model="ruleForm.duckOutColumn" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入年内出栏"></el-input> （只）
                                                    </el-form-item>
                                                    <el-form-item label="年末存栏" class="formItem">
                                                        <el-input v-model="ruleForm.duckExistColumn" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入年末存栏"></el-input> （只）
                                                    </el-form-item>
                                                </el-form>
                                            </div>
                                        </el-collapse-item>
                                        ...
                                        <el-collapse-item name="3-1-2">
                                            ...
                                            <div class="formContent">
                                                <el-form :model="ruleForm" status-icon label-width="100px" class="demo-ruleForm">
                                                    <el-form-item label="年内出栏" class="formItem">
                                                        <el-input v-model="ruleForm.gooseOutColumn" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入年内出栏"></el-input> （只）
                                                    </el-form-item>
                                                    <el-form-item label="年末存栏" class="formItem">
                                                        <el-input v-model="ruleForm.gooseExistColumn" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入年末存栏"></el-input> （只）
                                                    </el-form-item>
                                                </el-form>
                                            </div>
                                        </el-collapse-item>
                    ...
                    <el-collapse-item name="4">
                        ...
                        <div class="formContent">
                            <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                                ...
                                <el-form-item label="年内出栏" class="formItem">
                                    <el-input v-model="ruleForm.rabbitOutColumn" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入年内出栏"></el-input> （只）
                                </el-form-item>
                                <el-form-item label="年末存栏" class="formItem">
                                    <el-input v-model="ruleForm.rabbitExistColumn" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入年末存栏"></el-input> （只）
                                </el-form-item>
                        ...
                        <div class="formContent">
                            <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                                ...
                                <el-form-item label="总产量" class="formItem">
                                    <el-input v-model="ruleForm.yields	" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入总产量"></el-input> （个）
                                </el-form-item>
                                <el-form-item label="鸡蛋产量" class="formItem">
                                    <el-input v-model="ruleForm.eggYield" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入鸡蛋产量"></el-input> （个）
                                </el-form-item>
                                <el-form-item label="鹅蛋产量" class="formItem">
                                    <el-input v-model="ruleForm.gooseeggYiled" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入鹅蛋产量"></el-input> （个）
                                </el-form-item>
                                <el-form-item label="鸭蛋产量" class="formItem">
                                    <el-input v-model="ruleForm.duckeggYiled" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入鸭蛋产量"></el-input> （个）
                                </el-form-item>
