                    ...
                    <div class="formContent">
                        <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                            ...
                            <el-form-item label="当前存栏：" prop="amountNum" class="formItem">
                                <el-input v-model="ruleForm.amountNum" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');" :disabled="urlType" placeholder="请输入当前存栏量"></el-input>（头）
                            </el-form-item>
                            <el-form-item label="年末出栏：" prop="outNum" class="formItem">
                                <el-input v-model="ruleForm.outNum" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');" :disabled="urlType" placeholder="请输入年末出栏量"></el-input>（头）
                            </el-form-item>
                            <div style="clear:both;"></div>
