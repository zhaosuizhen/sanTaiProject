            ...
            <el-collapse  v-model="activeNames" @change="handleChange">
                <el-collapse-item name="0">
                    ...
                    <el-form :model="ruleForm" ref="ruleForm" status-icon :rules="rules" label-width="100px" class="demo-ruleForm">
                        ...
                        <el-form-item label="疾病种类" class="formItem">
                            <el-input v-model="ruleForm.pestsType" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入疾病种类"></el-input>
                        </el-form-item>
                        <el-form-item label="养殖种类" class="formItem">
                            <el-input v-model="ruleForm.breedType" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入养殖种类"></el-input>
                        </el-form-item>
                        <el-form-item label="发生率" class="formItem">
                            <el-input v-model="ruleForm.incidenceRate" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入发生率"></el-input>
                        </el-form-item>
                        <el-form-item label="死亡率" class="formItem">
                            <el-input v-model="ruleForm.deathRate" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入死亡率"></el-input>
                        </el-form-item>
                        <el-form-item label="治愈率" class="formItem">
                            <el-input v-model="ruleForm.cureRate" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入治愈率"></el-input>
                        </el-form-item>
                        <el-form-item label="疫病损失数量" class="formItem">
                            <el-input v-model="ruleForm.lossNum" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入疫病损失数量"></el-input>
                        </el-form-item>
                    </el-form>
...
import { diseaseControlDataDetail,diseaseControlDataUpdate, diseaseControlDataInsert } from '@/utils/api/plantProtectionStation/diseaseControlData' 
...
export default {
    ...
    methods:{
        ...
        async getDataDetail(){
            ...
            let res = await diseaseControlDataDetail({id:this.id});
        ...
        async updateData(){
            ...
            let res = await diseaseControlDataUpdate(updateObj);
             if(res.data.status== 0){
                this.$message({
                    message: '编辑成功',
                    type: 'success'
        ...
        async addData(){
            ...
            let res = await diseaseControlDataInsert(addObj);
             if(res.data.status== 0){
                this.$message({
                    message: '新增成功',
                    type: 'success'
