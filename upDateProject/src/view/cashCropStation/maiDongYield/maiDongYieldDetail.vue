                        ...
                        <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                           <el-form-item label="年份" prop="years" class="formItem formSelect">
                            ...
                            <el-form-item label="鲜产量" prop="freshYield" class="formItem">
                                <el-input v-model="ruleForm.freshYield" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入鲜产量"></el-input> (吨)
                            </el-form-item>
                            <el-form-item label="干货产量" prop="dryYield" class="formItem">
                                <el-input v-model="ruleForm.dryYield" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入干货产量"></el-input> (吨)
                            </el-form-item>
                        </el-form>
                    </div>
                </el-collapse-item>
