                                    ...
                                    <div class="formContent">
                                        <el-form :model="ruleForm" status-icon label-width="100px" class="demo-ruleForm">
                                            <el-form-item label="水田" class="formItem">
                                                <el-input v-model="ruleForm.landPaddy" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入水田"></el-input> （吨）
                                            </el-form-item>
                                            <el-form-item label="旱地" class="formItem">
                                                <el-input v-model="ruleForm.landDry" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入旱地"></el-input> （吨）
                                            </el-form-item>
                                            <el-form-item label="水浇地" class="formItem">
                                                <el-input v-model="ruleForm.landWater" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入水浇地"></el-input> （吨）
                                            </el-form-item>
                                        </el-form>
                                    </div>
                                </el-collapse-item>
