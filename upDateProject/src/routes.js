...
import rpManage from './view/ruralEconomy/rpManage/rpManage' //藤椒经营主体
import rpManageDetail from './view/ruralEconomy/rpManage/rpManageDetail' //藤椒经营主体 新增编辑页
import rpInformation from './view/ruralEconomy/rpInformation/rpInformation' //藤椒基本信息
import rpInformationDetail from './view/ruralEconomy/rpInformation/rpInformationDetail' //藤椒基本信息 新增编辑页
import industrialDevelopment from './view/ruralEconomy/industrialDevelopment/industrialDevelopment' //产业发展
import industrialDevelopmentDetail from './view/ruralEconomy/industrialDevelopment/industrialDevelopmentDetail' //产业发展 新增编辑页
import vegetableDevelopment from './view/ruralEconomy/vegetableDevelopment/vegetableDevelopment' //蔬菜发展情况
import vegetableDevelopmentDetail from './view/ruralEconomy/vegetableDevelopment/vegetableDevelopmentDetail' //蔬菜发展情况 新增编辑页
...
import diseaseControlData from './view/plantProtectionStation/diseaseControlData/diseaseControlData.vue' //植保站---疾病防治数据
import diseaseControlDataDetail from './view/plantProtectionStation/diseaseControlData/diseaseControlDataDetail.vue' //植保站---疾病防治数据
        ...
        children: [
            ...
            { //农经股
                ...
                children:[
                    ...
                    {path: '/rpManage', component: rpManage, name: '藤椒经营主体', meta: {requireAuth: true}},
                    {path: '/rpManageDetail', component: rpManageDetail, name: '藤椒经营主体修改详情', meta: {requireAuth: true}},
                    {path: '/rpInformation', component: rpInformation, name: '藤椒基本信息', meta: {requireAuth: true}},
                    {path: '/rpInformationDetail', component: rpInformationDetail, name: '藤椒基本信息修改详情', meta: {requireAuth: true}},
                    {path: '/industrialDevelopment', component: industrialDevelopment, name: '产业发展', meta: {requireAuth: true}},
                    {path: '/industrialDevelopmentDetail', component: industrialDevelopmentDetail, name: '产业发展修改详情', meta: {requireAuth: true}},
                    {path: '/vegetableDevelopment', component: vegetableDevelopment, name: '蔬菜发展情况', meta: {requireAuth: true}},
                    {path: '/vegetableDevelopmentDetail', component: vegetableDevelopmentDetail, name: '蔬菜发展情况修改详情', meta: {requireAuth: true}},
                ]
            },
            { //种植业股
                path:'/planting',
            ...
            { //植保站
                ...
                children:[
                    ...
                    {path: '/diseaseControlData', component: diseaseControlData, name: '疾病防治数据', meta: {requireAuth: true}},
                    {path: '/diseaseControlDataDetail', component: diseaseControlDataDetail, name: '疾病防治数据添加修改详情', meta: {requireAuth: true}},
                ]
            },
            { //数据备份
                path:'/dataSecurity',
