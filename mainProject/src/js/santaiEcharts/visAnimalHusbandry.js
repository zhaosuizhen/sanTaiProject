    ...
    happen_defense(id, data, index){
        data.forEach(item => {
            if(item.name == "egg_yiled"){
                ...
                item.name = '羊出栏(头)'
            }else if(item.name.includes("蛋产量")){
                item.name = `${item.name}(个)`
            }else if(item.name == '鸡存栏量'){
                item.name = '鸡存栏量(只)'
            }else if(item.name == '鸭存栏量'){
                item.name = '鸭存栏量(只)'
            }else if(item.name == '鹅存栏量'){
                item.name = '鹅存栏量(只)'
            }else if(item.name == '鸡出栏量'){
                item.name = '鸡出栏量(只)'
            }else if(item.name == '鸭出栏量'){
                item.name = '鸭出栏量(只)'
            }else if(item.name == '鹅出栏量'){
                item.name = '鹅出栏量(只)'
            }
        })
