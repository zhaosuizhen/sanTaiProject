...
export default {
  // *******投入品数据*******
  //投入品占比 柱状图
  EchartsInputsProportion: function(id, data) {
        ...
        series: [
          {
            name: '投入品占比',
            type: 'pie',
            color: ['#e7bcf3','#ff9f7f','#9fe6b8','#37a2da'],
            radius: ['70%', '85%'],
            center: ['30%', '50%'],
  ...
  //地膜 柱状图
  EchartsInputsFilmChart: function(id, dataX, dataY1) {
    let myChart = echarts.init(document.getElementById(id));
  ...
  //农药 柱状图
  EchartsInputsPesticideChart: function(id, dataX, dataY) {
    let myChart = echarts.init(document.getElementById(id));
  ...
  //柴油
  EchartsInputsSeedChart: function(id, dataX, dataY) {
    let myChart = echarts.init(document.getElementById(id));
  ...
  //化肥 柱状图
  EchartsInputsChemicalChart: function(id, dataX, dataY) {
    let myChart = echarts.init(document.getElementById(id));
