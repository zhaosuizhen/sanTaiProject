    ...
    <div class="management-top2">
      ...
      <el-col :span="6" class="management-top-aside2">
        ...
        <div class="management-top-div2">
          <!-- <div class="management-charts-title">粮油产业数据({{LYCY_year}})</div> -->
          <div class="management-charts-title">粮油产业数据(2020)</div>
            ...
            <div class="right_text right_text_XMYZ" style="width:45%">
              <ul class="coolPig">
                <li>
                  ...
                  <p><span>176.9</span><span style="color:#fff;font-size:0.1rem">/万亩</span></p>
                ...
                <li>
                  ...
                  <p><span>66.24</span><span style="color:#fff;font-size:0.1rem">/万吨</span></p>
                ...
                <li>
                  ...
                  <p><span>79</span><span style="color:#fff;font-size:0.1rem">/万亩</span></p>
                ...
                <li>
                  ...
                  <p><span>15</span><span style="color:#fff;font-size:0.1rem">/万吨</span></p>
            ...
            <div class="table_box">
              <ul class="geXiangZhenQinDanChanLiang" id="roll_table_WGH_1">
                <li v-for="(item,index) in LYJG_value" :key="index">
                  ...
                  <span class="title_township" style="color:#fff;text-align:center">{{item.oil_price_sc}}</span>
                  <span class="title_eggYield" style="color:#fff;text-align:center">{{item.oil_price_country}}</span>
                  <span class="title_duckeggYiled" style="color:#fff;text-align:center">{{item.value}}</span>
                </li>
              </ul>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    async getOilsIndustryData(){
      ...
      console.log(res);
      this.LYCY_year = res.data.data[0].years
