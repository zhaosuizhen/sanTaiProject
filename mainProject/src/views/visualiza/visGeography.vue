    ...
    <div class="management-top">
      ...
      <el-col :span="6" class="management-top-aside">
        ...
        <div class="management-top-div">
          <div class="management-charts-title">土地资源结构({{TDZY_year}})</div>
        ...
        <div class="management-top-div" >
          <div class="management-charts-title">耕地面积占比({{GDMJ_year}})</div>
      ...
      <el-col :span="6" class="management-top-aside">
        ...
        <div class="management-top-div">
          <div class="management-charts-title">耕地地力等级(2019)</div>
          <div class="content_box">
            <!-- <div class="text_box">
              <div>
                <span>年平均气温/℃</span>
        ...
        <div class="management-top-div" style="position: relative;">
          ...
          <div class="dataUpdate">数据未脱密</div>
            <!-- <div class="text_box">
    ...
    <div class="management-bottom">
      ...
      <el-col :span="12">
        <div class="management-bottom-other-div" style="position: relative;">
          <div class="management-charts-title">幸福美丽新村(2019)</div>
      ...
      <el-col :span="12">
        <div class="management-bottom-other-div">
          <div class="management-charts-title">乡镇耕地分布({{GDFB_year}})</div>
            <div class="text_box_1">
...
export default {
  ...
  methods: {
    ...
    async getLanduse(){
      ...
      this.TDZY_year = res.data.data[0].year
    ...
    async getGDFB_data(){
      ...
      this.GDFB_year = res.data.data[0].data_year
      this.GDMJ_year = res.data.data[0].data_year
    ...
    async getGDMJZB_data(){
      ...
      this.GDMJ_year = res.data.data[0].years
      res.data.data.forEach((item,index) => {
        this.GDMJ_name[index] = item.types
      })
      this.GDMJ_data = res.data.data.map( item => {
        if(item.areas){
          this.GDMJ_total = this.GDMJ_total + item.areas * 1
        }
