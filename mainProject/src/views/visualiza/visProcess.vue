    ...
    <div class="management-top">
      ...
      <el-col :span="6" class="management-top-aside">
        ...
        <div class="management-top-div">
          <div class="management-charts-title">渔业养殖品种占比({{YZPZ_year}})</div>
        ...
        <div class="management-top-div" style="position: relative;">
          <div class="management-charts-title">渔业人口({{YYRK_year}})</div>
      ...
      <el-col :span="6" class="management-top-aside">
        <div class="management-top-div3" style="height:97%">
          <div class="management-charts-title">渔业养殖({{YYYZ_year}})</div>
          <div class="content_box">
            <!-- <div class="text_box">
              <div>
                <span>出栏数量/头</span>
    ...
    <div class="management-bottom">
      ...
      <el-col :span="12">
        <div class="management-bottom-other-div">
          <div class="management-charts-title">主要品种养殖规模({{ZYPZ_year}})</div>
          <div class="content_box">
      ...
      <el-col :span="12">
        <div class="management-bottom-other-div" style="position: relative;">
          <!-- <div class="management-charts-title">渔业执法情况({{YYZF_year}})</div> -->
          <div class="management-charts-title">渔业执法情况(2019)</div>
...
export default {
  ...
  methods: {
    ...
    async getMainTypeScale(){
      ...
      let newArr = []
      this.ZYPZ_year = res.data.data[0].years
    ...
    async getFisheriesPeople(){
      ...
      this.YYRK_year = res.data.data.data_year
    ...
    async getAquaticTypeProportion(){
      ...
      this.YZPZ_year = res.data.data[0].year
