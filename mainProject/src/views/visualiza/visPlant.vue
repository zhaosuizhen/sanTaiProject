    ...
    <div class="management-top">
      ...
      <el-col :span="6" class="management-top-aside">
        ...
        <div class="management-top-div">
          <div class="management-charts-title">农业从业人口({{NYCYRK_year}})</div>
          <ul class="yuYeRenKou">
              <li>
                <span>类型</span>
                <span>人数</span>
      ...
      <el-col :span="6" class="management-top-aside">
        ...
        <div class="management-top-div" >
          <div class="management-charts-title">粮食作物({{LSZW_year}})</div>
          <div class="text_box">
              <div>
                <span>总面积</span>
        ...
        <div class="management-top-div">
          <div class="management-charts-title">经济作物({{JJZW_year}})</div>
          <div class="text_box">
              <div>
                <span>总面积</span>
    ...
    <div class="management-bottom">
      ...
      <el-col :span="12">
        <div class="management-bottom-other-div">
          <div class="management-charts-title">种植类型占比({{ZZLX_year}})</div>
          <div class="text_box">
              <div>
                <span>总面积</span>
      ...
      <el-col :span="12">
        <div class="management-bottom-other-div">
          <div class="management-charts-title">种植面积({{ZZMJ_year}})</div>
  ...
  export default {
    ...
    methods: {
      ...
      async getPeopleCountsData(){
        ...
        this.NYCYRK_year = res.data.data.data_year
        this.NYCYRK_value = res.data.data
      },
      //获取种植面积数据  
      async getXZQSLS_data(){
        let res = await getXZQSLS()
        this.ZZMJ_year = res.data.data[0].years
      ...
      async getProductionByType(){
        ...
        this.LSZW_year = res_LS.data.data[0].years
        this.JJZW_year = res_JJ.data.data[0].year
      ...
      async getPZCL_data(){
        ...
        this.ZZLX_year = res.data.data[0].years
