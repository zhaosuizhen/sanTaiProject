          ...
          <div class="webSite-marketnew-table" style="margin-top: -5%;">
            ...
            <div class="webSite-table-content">
              <el-table :data="tableData" :header-cell-style="getRowClass" highlight-current-row border style="width: 100%" @selection-change="selsChange">
                ...
                <el-table-column prop="cattleOutColumn" label="牛出栏（头）"></el-table-column>
                <el-table-column prop="cattleExistColumn" label="牛存栏（头）"></el-table-column>
                <el-table-column prop="sheepOutColumn" label="羊出栏（头）"></el-table-column>
                <el-table-column prop="sheepExistColumn" label="羊存栏（头）"></el-table-column>
                <el-table-column prop="JQ_out" label="家禽出栏（只）"></el-table-column>
                <el-table-column prop="JQ_in" label="家禽存栏（只）"></el-table-column>
                <el-table-column prop="rabbitOutColumn" label="兔出栏（只）"></el-table-column>
                <el-table-column prop="rabbitExistColumn" label="兔存栏（只）"></el-table-column>
                <el-table-column prop="eggCount" label="禽蛋产量（个）"></el-table-column>
              </el-table>
              <!--分页-->
