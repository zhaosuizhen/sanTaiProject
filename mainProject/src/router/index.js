...
import special from '@/views/webSite/special'     //农业资源专题
//信息服务组件
...
import MAP from '@/views/visualiza/middleMap12'       //麦冬种植
...
export default new Router({
  ...
  routes: [
    ...
    // *****管理平台*****
    {
      ...
      name: '',
      children: [
        {path: '/industryAnalysisIndex', name: '首页', component: industryAnalysisIndex},  //主页
        ...
        {path: '/visAgriculturalData', name: '农机数据', component: visAgriculturalData},                //农机数据
        ...
        {path: '/visDiseases', name: '病虫害', component: visDiseases},                    //病虫害
        {path: '/visMarket', name: '市场交易', component: visMarket},                      //市场交易
        {path: '/visInputs', name: '投入品数据', component: visInputs},                    //投入品数据
        {path: '/visSource', name: '质量溯源', component: visSource},                      //质量溯源
        {path: '/visLivestock', name: '生猪养殖', component: visLivestock},                //畜禽养殖
        {path: '/visOphiopogon', name: '麦冬种植', component: visOphiopogon},                //麦冬养殖
        {path: '/visVegetables', name: '蔬菜种植', component: visVegetables},                //蔬菜种植
        {path: '/visRattanPepper', name: '蔬菜种植', component: visRattanPepper},                //藤椒种植
        {path: '/visAnimalHusbandry', name: '畜牧养殖', component: visAnimalHusbandry},                //畜牧养殖
