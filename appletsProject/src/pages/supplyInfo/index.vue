...
<!-- 供求信息页面 -->
	<view class="content">
		<van-search class="searchBox" :value="getListValue.productName" placeholder="请输入搜索关键词" @search="confirmSearch" />
		<!-- banner图片 -->
		<image class="bannerImg" src="/static/bannner.png"></image>
		<!-- NAV导航 -->
		<view class="nav">
			<ul>
		...
		<view class="bottomBtn">
			...
			<van-button class="btn" size='large' type='info' @click="goToUser">我的</van-button>
		</view>
	</view>
</template>
